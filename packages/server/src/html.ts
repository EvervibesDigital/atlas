...
// ── Neural map ──
const MAP_GROUPS = { core:["brain","memory","executive","approvals","guardian","backup","skills","forge"], create:["creative","publishing","personas","web"], intel:["research","opportunity","strategy","analytics","detective","simulation","knowledge","experiments","codebase","curiosity","archaeologist","legacy"], money:["cfo","negotiation","business","toolvault","connectors"], ops:["learning","automation","techdebt","engineering","compliance","actions","inbox","redteam","janitor"] };
